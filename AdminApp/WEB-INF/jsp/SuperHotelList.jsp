...
<style>
	.customFont {
	   ...
	   .textwidth{ width: 91% !important;}
	   .dynamicAppDataAppend td{
		...
		<li><a href="#modal4" class="modal-trigger searchUsers"
			...
			<li><a  id="acAdmin" style="font-size: 1rem; padding: 0.5rem 0.5rem;">Create CS Admin User</a></li>
   			...
   			<li><a href="#modal3" class="modal-trigger skipGroup"
				...
				<li><a href="#modalMA"  id="manageapp"  class="modal-trigger2 skipGroup"
				style="font-size: 1rem; padding: 0.5rem 0.5rem;"">Manage Apps</a></li> 
...
<!--  end of the update Super admin popup -->
	...
	<!-- start change template popup -->
	 ...
	 <div id="modalMA" class="modal" style="overflow:auto" data-toggle="modal">
	  <a href="#!" class="ManageAppclose modal-action  waves-effect waves-green btn-flat right">Close</a>
	     <div class="modal-content" style=box-shadow:none !important>
	       <a id="addapp"   class="modal-trigger2 waves-light btn right" href="#modaladd" style="margin:15px 7px">Add App</a>
	...
	<!-- Add App popup code starts  -->
	  ...
	  <div id="modaladd" class="modal" style="width:30%;margin-top:0%" data-toggle="modal">
      ...
      <div class="modal-content">
		...
		<p id="msg" style="color:green;font-size:15px"/>
         ...
         <span id="appExistErr" style="color:red;font-size:13px"></span>
		  ...
		  <!--     <div class="input-field col s12 ">
		  <input  type="text"  name="mobileqr" class="customFont" id="mobileqr" style="margin-bottom:3px" required>
             <label for="mobileqr" class="customFont" style="padding:0 10px 0 10px">MobileQRlink</label>
             <span id="appExistErr" style="color:red;font-size:13px"></span>
             <span id="appNameErr" style="color:red;font-size:13px"></span> 
		     <select required  class="browser-default" name="templateId" id="addTemplateId">
		      <option value="" disabled selected>Choose Template</option>
		     ...
		     <div class="input-field col s12 ">
		    <input  type="text"  name="webqr" class="customFont" id="webqr" style="margin-bottom:3px" required>
             <label for="webqr" class="customFont" style="padding:0 10px 0 10px">WebQRlink</label>
             <span id="appExistErr" style="color:red;font-size:13px"></span>
             <span id="appNameErr" style="color:red;font-size:13px"></span> 
		     <select required  class="browser-default" name="templateId" id="addTemplateId">
		      <option value="" disabled selected>Choose Template</optio
		     </select>
		     <span id="groupIdErr" style="color:red;font-size:13px"></span>
		    </div> 
		     -->
		  ...
		  <center style="margin-top:5%"><a href="javascript: addAppSubmitform()" class="addNewApp waves-light btn">Add</a></center> 
       </div>
  ...
  <!-- Edit App popup code starts -->
   <div id="appEditIds"  class="modal" style="width:30%;margin-top:5.5% !important;" data-toggle="modal">
  <form:form action="editApp" method="post" name="editApp">
   <a href="#!" id="appEdited" class="editApp1 modal-action right waves-effect waves-green btn-flat">Close</a>
      <div class="modal-content">
      	<div class="preloader-wrapper small active gspin" style="display:none;margin:2% 0 0 50%">
		    <div class="spinner-layer spinner-green-only">
		      <div class="circle-clipper left">
		...
		<p id="updatemsg" style="color:green;font-size:15px"/>
         ...
         <input type="hidden" id="editObjectId">
           ...
           <input type="hidden" value="${locId}" name="locId">
            --%>
           <input type="text"   name="appId" class="customFont textwidth" id="editAppId" value=""   style="margin-bottom:3px ;padding:0 16px !important;margin-top: 18px; color:#b3b3b3;" disabled>
         ...
         <span id="appEditIdErr" style="color:red;font-size:13px"></span>
   		   ...
   		   <div class="input-field col s12 ">
		  <input type="text"  placeholder=" " value="" name="appName" class="customFont textwidth"  id="editAppName" style="margin-bottom:3px ;padding:0 16px !important;margin-top: 18px;">
             <label for="name" class="customFont" style="padding:0 10px 0 10px">App Name</label>
		   ...
		   <!-- <button class="btn waves-effect waves-light" type="submit"
					name="action">Add</button> -->
		  <center style="margin-top:5%"><a id="editNewApp"  class="waves-effect waves-light btn updatedisbale updateappdata">Update</a></center> 
       </div>
  ...
  <div id="deleteAppmodal"  class="modal deleteAppModal" style="width:30%; display:none;" data-toggle="modal">
  	 <form:form action="deleteApp" method="post" name="deleteApp">
  	  <a href="#!" id="appDeleted" class="deleteApp1 modal-action right waves-effect waves-green btn-flat">Close</a>
  	 <div class="modal-content">
 		 <div class="preloader-wrapper small active gspin" style="display:none;margin:2% 0 0 50%">
		    <div class="spinner-layer spinner-green-only">
		      <div class="circle-clipper left">
		    ...
		    <h3 style="font-size:20px;">Are you sure delete this app ?</h3>
	...
	<div id="addHotel" class="modal">
	  <form:form action="addLocation" commandName="addLocation" name="addLocation" enctype="multipart/form-data">
...
<%-- 
				<div class="row">
					<div class="input-field col s6">
						<select class="browser-default" required id="egsdApp"
							name="appName">
							<option value="" selected disabled>Choose App/Brand</option>
							<c:forEach var="systemapps" items="${systemapps}">
								<option value="${systemapps.appId}">${systemapps.appName}</option>
							</c:forEach>
							<option value='none'>None</option>
						</select> <span id="egsdApperr1" style="font-size: 13px; color: red"></span>
					</div>
					<div class="input-field col s1"></div>
					
					<div class="input-field col s5">
									<input type="checkbox" id="globalstatus" name="globalstatus"/>
      								<label for="globalstatus">Global Participant</label>
								</div>
				</div>
 --%>
				           <div class="">
...
style="margin:0em auto 1em auto; display:block; padding:4px;
 ...
 -->
		...
		<!-- <script src="../js/superHotelList.js"></script> -->
	...
	$('#deleteAdminDetails').click(function(){
		...
		function hotelSubmitform()
		{
			...
			//var appName = $('#egsdApp').val();
			//var gstatus = $('#globalstatus');
			...
			/* if(appName == "" || appName == null)
				{
				$('#egsdApperr1').text("Please select the App/Brand.");
				hotelResult++;
				}
			else{
				$('#egsdApperr1').empty();
		...
		<script>
		 ...
		 $("#appadded").click(function(){
			 $("#msg").empty();
			// $('.appadded').prop('disabled', false).removeClass('disabled').on( "click" );
			 
			// $(".dynamicAppDataAppend").empty();
				//getAddedApps();
		});
		 
		 $(".editApp1").click(function(){
			 $(".updatedisbale").removeClass('disabled');
			 //$('.updatedisbale').prop('disabled', false).removeClass('disabled').on( "click" );
				getAddedApps();
				$('#appEditIds').closeModal();
				$('#modaladd').closeModal();
				$("#deleteAppmodal").closeModal();
			...
			// $("#egsdApp").empty();
			 ...
			 $.ajax({
					...
					success:function(appData){
						...
						var  editOptions = "<option value='"+editHiddenAppId+"'>"+editHiddenAppName+"</option>";
						var data;
						var optionArray=[];
		...
		function editAppData(appId){
			$("#updatemsg").empty();
			 //$("#editNewApp").prop("disabled", false);
			 
		  // $('.updatedisbale').prop('disabled', false).removeClass('disabled').on( "click" );
			//$(".updatedisbale").prop('disabled', false).addClass("active");
			//$("#editNewApp").removeAttr("disabled");
			//$('.updatedisbale').prop('disabled', false)
			$("#appEditIdErr").empty();
			...
			$.ajax({
			 ...
			 function deleteAppData(appId){
					$("#deleteAppmodal").openModal('modal');
					//$('#deletedAppMsg').empty();
					$("#appEditIds").closeModal();
					$("#modaladd").closeModal();
					$("#appObjectID").val(appId);
					$("#confirmDeleteAdpp").removeClass('disabled');
		...
		$("#confirmDeleteAdpp").click(function(){
			...
			$.ajax({
				...
				success:function(appResult){
					...
					//	$('#confirmDeleteAdpp').prop('disabled', true).addClass('disabled').off( "click" );
					$('#confirmDeleteAdpp').addClass('disabled');
		...
		$(".deleteApp1").click(function(){
			$('#modaladd').closeModal();
			$('#appEditIds').closeModal();
			$("#deleteAppmodal").closeModal();
			//$("#appEditIds").closeModal({ dismissible: true});
			$('#deletedAppMsg').text('');
			//$("#modaladd").closeModal(); ;
			//$("#editAppData").closeModal(); ;
			getAddedApps();
		});
		
		$(".ManageAppclose").click(function(){
			$("#deleteAppmodal").closeModal();
			$('#modaladd').closeModal();
			$('#appEditIds').closeModal();
			$('#modalMA').closeModal();
			...
			if(i==0){
				$.ajax({
					...
					success:function(res){
		   			...
		   			$('.updatedisbale').addClass('disabled');
		   			
		   			     $("#editNewApp").prop("disabled", true);    
						 }
		   				  else{
		...
		$("#editsystemapps").click(function(){
		 ...
		 /*add app appId validation code starts*/
		...
		var str = String.fromCharCode(!e.charCode ? e.which : e.charCode);
		 ...
		 /*add app appId validation code ends*/
		...
		function addAppSubmitform()
		{
				...
				$.ajax({
				      ...
				      success :function(result) {
				    	  if(result == "duplicate")
				    	  {
				    		  ...
				    		  $('#appNameErr').empty();
				    		 // $('#modaladd').closeModal({ dismissible: true});
				    		  $('.gspin').hide();
				    		  appResult++;
				    		...
				    		//  $('.addNewApp').attr('disabled','disabled');
				    		  ...
				    		  $.ajax({
				    			  ...
				    			  success:function(res){
				    				  ...
				    				  getAddedApps();
				    				//  $('.addNewApp').prop('disabled', true).addClass('disabled').off( "click" );
				    				  $('.addNewApp').addClass('disabled');
		 ...
		 $('#addapp').click(function(){
				...
				//$('.addNewApp').removeAttr('disabled');
				  $('.addNewApp').removeClass('disabled');

...
<link href="https://fonts.googleapis.com/icon?family=Material+Icons"
	rel="stylesheet">
<title>Super Admin Page | eGSD Admin Template</title>
...
<form:form action="adminApp" commandName="adminApp" name="adminApp"
   ...
   <a id="${locObjForAddDirectoryItems.objectId }" class="btn" onclick="admin_app(this.id)" style="margin-top:-698px;margin-left:33px;width:100px;color:white;    margin-left: 1099px; padding: 10PX;" >SUBMIT</a>
	...
	<%-- <div id="modal29" class="modal checkbox_input"
		style="overflow: auto; width: 1400px;">
		<c:forEach var="locObjForAddDirectoryItems"
			...
			<a href="#" onclick="closeDiv()"
				...
				style="margin-right: 7px; color: white; margin-top: 10px; width: 100px; background-color: #26a69a;!important">CANCEL</a>
			<form:form action="adminApp" commandName="adminApp" name="adminApp"
				enctype="multipart/form-data">
				...
				<div class="modal-content">
					...
					<div class="main" style=" height: 597px;">
						<div class="table">
							<table style="margin-left: 69px;">
								<thead>
									<tr style="width: 81%;">
										<th data-field="show" style="width: 11%">Show
											<hr>
										</th>
								...
								<tbody>
									<tr>
										...
										<td><i class="large material-icons">call</i></td>
										<td><input type="checkbox" maxlength="1" id="test1350"
									...
									<tr>
										...
										<td><input type="checkbox" id="test135"
											onclick="clicking()" /></td>
										<td><div id="dvPassport50" style="display: none">
									...
									<tr>
										...
										<td><input type="checkbox" id="test107"
									...
									<tr>
										...
										<td><input type="checkbox" id="test109"
									...
									<span id="dvPa5"></span>		
										...
										<td><input type="checkbox" id="test111"
									...
									<tr>
										...
										<td><i class="large material-icons"><image
													...
													style="height: 50px"></i></td>
										<td><input type="checkbox" id="test113"
									...
									<span id="dvPa7"></span>		
										...
										<td><i class="large material-icons"><image
													...
													style="height: 50px"></i></td>
										<td><input type="checkbox" id="test115"
									...
									<span id="dvPa8"></span>		
										...
										<td><i class="large material-icons"><image
													...
													style="height: 50px"></i></td>
										<td><input type="checkbox" id="test117"
									...
									<tr>
										...
										<td><i class="large material-icons"><image
													...
													style="height: 50px"></i></td>
										<td><input type="checkbox" id="test119"
					...
					<!--  <input type="button" name="submit" value="submit" style="margin-left: 1146px;
    margin-top: -667px;"> -->
					<a id="${locObjForAddDirectoryItems.objectId }" class="btn"
						onclick="admin_app(this.id)"
						style="margin-top: -698px; margin-left: 33px; width: 100px; color: white; margin-left: 1099px; padding: 10PX;">SUBMIT</a>
	...
	<!-- END OF DIRECTORY EDIT -->
		...
		<!--start of edit location  -->
			...
			<div id="editLocation" class="modal" style="width:91%;margin-top:36px;overflow: auto;">
				<a href="#"
					class="waves-effect waves-green btn-flat modal-action modal-close right  waves-effect waves-light btn btn clearData"style="margin-right: 22px;;margin-top:20px;background-color:#20B2AA;padding:12px; width:100px;color:white" >CANCEL</a>
 ...
 -->       
    ...
    <div id="test11" class="col s10"style="margin-top: 40px;">
    	<div class="row">
												...
												<div class="input-field col s3">
 												...
 												<div class="input-field col s3">
													<input type="text" style="font-weight: normal; font-size: 14px; background-image: none; color: rgb(54, 35, 219)"  id="dirTitleColor" name="titleColor" class="color" autocomplete="off"> <label style="font-weight: normal; font-size: 14px;" class="active">Color</label>
												</div>
												<div class="input-field col s3">
    ...
    <div id="test22" class="col s10" style="margin-top: 40px;">
    	<div class="row">
    											...
    											<div class="input-field col s3" style="display: none">
													<input type="text" style="font-weight: normal; font-size: 14px" required="" class="title" id="dirCapt" > <label style="font-weight: normal; font-size: 14px" class="active">Group Site ID</label>
												</div>
    ...
    <div id="test33" class="col s10" style="margin-top: 40px;">
    	<div class="row">
												...
												<div class="input-field col s3">
													<input type="text" style="font-weight: normal; font-size: 14px; background-image: none; color: rgb(54, 35, 219);" id="dirCaptionColor"  name="addressColor" class="color" autocomplete="off"> <label style="font-weight: normal; font-size: 14px;" class="active">Color</label>
												</div>
												<div class="input-field col s3">
...
<!--       </div> -->
<!--       <div class="file-path-wrapper" > -->
<!--         <input class="file-path validate" id="imgUrl1" type="text" style="font-size:20px;width:400px;height:39px; margin-top: 50px; -->
<!--     margin-left: 3px;"> -->
<!--       </div> -->
<!--       </div> -->
<!--       <div> -->
...
<!--       </div> -->
<!--       <div class="file-path-wrapper" > -->
<!--         <input class="file-path validate" id="imgUrl2" type="text" style="font-size:20px;width:400px;height:39px; margin-top: 20px; -->
<!--     margin-left: 3px;"> -->
<!--       </div> -->
<!--       </div> -->
...
<!--       </div> -->
<!--       <div class="file-path-wrapper" > -->
<!--         <input class="file-path validate" id="imgUrl3" type="text" style="font-size:20px;width:400px;height:39px; margin-top: 20px; -->
<!--     margin-left: 3px;"> -->
<!--       </div> -->
<!--       </div> -->
...
<div id="test55" class="col s10">
    ...
    <div id="test66" class="col s10" style="margin-top: 40px;">
    	<div class="row">
												<div class="input-field col s3">
													<input type="text" value ="Brand Color" readonly style="font-weight: normal; font-size: 14px" required="" class="title" id="dirCaption" name="brandId" value=""> <label style="font-weight: normal; font-size: 14px" class="active">Brand Color</label>
												</div>
												<div class="input-field col s3">
													<input type="text" style="font-weight: normal; font-size: 14px; background-image: none; color: rgb(54, 35, 219);" id="brandBGColor"  name="brandBGColor" class="color" autocomplete="off"> <label style="font-weight: normal; font-size: 14px;" class="active">Background Color</label>
												</div>
												 <div class="input-field col s3">
													<input type="text" style="font-weight: normal; font-size: 14px; background-image: none; color: rgb(54, 35, 219);" id="brandColor"  name="brandColor" class="color" autocomplete="off"> <label style="font-weight: normal; font-size: 14px;" class="active">Color</label>
												</div> 
												 <div class="input-field col s3">
													<select name="brandFont" id="dirCaptionFont" class="browser-default">
														<option style="font-size: initial" value="initial">initial</option>
														<option style="font-size: xx-small" value="xx-small">xx-small</option>
														<option style="font-size: x-small" value="x-small">x-small</option>
														<option style="font-size: small" value="small">small</option>
...
<!--     <div id="test77" class="col s10" style="margin-top: 40px;">
    	<div class="row">
												...
												<div class="input-field col s3">
													<input type="text" style="font-weight: normal; font-size: 14px; background-image: none; color: rgb(54, 35, 219);" id="dirCaptionColor"  name="captionColor" class="color" autocomplete="off"> <label style="font-weight: normal; font-size: 14px;" class="active">Background Color</label>
												</div>
												<div class="input-field col s3">
													<input type="text" style="font-weight: normal; font-size: 14px; background-image: none; color: rgb(54, 35, 219);" id="dirCaptionColor"  name="captionColor" class="color" autocomplete="off"> <label style="font-weight: normal; font-size: 14px;" class="active">Color</label>
												</div>
 ...
 -->     
     ...
     <div id="test88" class="col s10" style="margin-top: 40px;">
    	<div class="row">
												<div class="input-field col s3">
													<input type="text" style="font-weight: normal; font-size: 14px" required="" class="title" id="dirCaption" name="footerSite"  > <label style="font-weight: normal; font-size: 14px" class="active">Footer</label>
												</div>
												<div class="input-field col s3">
													<input type="text" style="font-weight: normal; font-size: 14px; background-image: none; color: rgb(54, 35, 219);" id="dirCaptionColor"  name="footerbgColor" class="color" autocomplete="off"> <label style="font-weight: normal; font-size: 14px;" class="active">Background Color</label>
												</div>
												<div class="input-field col s3">
													<input type="text" style="font-weight: normal; font-size: 14px; background-image: none; color: rgb(54, 35, 219);" id="dirCaptionColor"  name="footerColor" class="color" autocomplete="off"> <label style="font-weight: normal; font-size: 14px;" class="active">Color</label>
												</div>
												 <div class="input-field col s3">
...
<div class="left">
 ...
 <div id="test7" class="col s10" style="margin-top:25px">
    <div class="input-field col s12"
						style="margin: 0px 0 17px 0px;padding:0 0 0 0">
  <div class="col s12" id="contactHBFJRBdxRo" style="padding: 0px; display: block;">
			...
			function edit_DirectoryItems_click(clicked_id) {
				...
				$.ajax({
				      ...
				      success :function(result) {
					    	  ...
					    	  $('#dirTitleFont0').append('<option selected style="font-size:'+result.styleList[0].titleFont+'" value="'+result.styleList[0].titleFont+'">'+result.styleList[0].titleFont+'</option>');
					    	  $('#dirTitleFamily0').append('<option selected style="font-family:'+result.styleList[0].titleFamily+'" value="'+result.styleList[0].titleFamily+'">'+result.styleList[0].titleFamily+'</option>');
					    	  $('#dirCaption0').val(result.directoryList[0].caption);
					    	  $('#dirCaptionColor0').val(result.styleList[0].captionColor);
					    	  $('#dirCaptionFont0').append('<option selected style="font-size:'+result.styleList[0].captionFont+'" value="'+result.styleList[0].captionFont+'">'+result.styleList[0].captionFont+'</option>');
					    	  $('#dirCaptionFamily0').append('<option selected style="font-family:'+result.styleList[0].captionFamily+'" value="'+result.styleList[0].captionFamily+'">'+result.styleList[0].captionFamily+'</option>');
					    	  $('#dirTimings0').val(result.directoryList[0].timings);
					    	  $('#dirTimingsColor0').val(result.styleList[0].timingsColor);
					    	  $('#dirTimingsFont0').append('<option selected style="font-size:'+result.styleList[0].timingsFont+'" value="'+result.styleList[0].timingsFont+'">'+result.styleList[0].timingsFont+'</option>');
					    	  $('#dirTimingsFamily0').append('<option selected style="font-family:'+result.styleList[0].timingsFamily+'" value="'+result.styleList[0].timingsFamily+'">'+result.styleList[0].timingsFamily+'</option>');

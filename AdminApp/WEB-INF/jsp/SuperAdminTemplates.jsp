 ...
 <!-- start add hotel popup -->
	...
	<c:forEach var="listOfEgsdTemplateObjects" items="${listOfEgsdTemplateObjects}">
						...
						<div class=${listOfEgsdTemplateObjects.objectId } style="display: none; padding: 10px; text-align: justify">
								...
								<input type="hidden" name="user" value="${user}">
								<input type="hidden" name="userName" value="${userName}">
								<input type="hidden" name="appId" value="${listOfEgsdTemplateObjects.appId}" id="editHiddenAppID">
								<input type="hidden" name="appName" value="${listOfEgsdTemplateObjects.appName}" id="editHiddenAppName">
								<input type="hidden" name="globalStatus" value="${listOfEgsdTemplateObjects.globalStatus}">
...
">
      <ul class="tabs tabs-left"style="margin-top: 45px;">
        ...
        <li class="tab col s12"><a href="#template77" style="color:white !important" id="editsystemapps">Apps</a></li> 
    ...
    margin-top: 40px;">
									...
									<div id="template44" class="col s10" style="">
										<div class="row" style="margin-left: 10px; margin-top: 40px;">
											<div class="input-field col s3">
												<input type="text"
													style="font-weight: normal; font-size: 14px" placeholder=""
													required="" class="title" name="templateFooterText"
													value="${listOfEgsdTemplateObjects.templateFooterText}">
												<label
													style="font-weight: normal; font-size: 14px; margin-left: -7px;"
													class="active">Footer Text</label>
											</div>
											<div class="input-field col s2">
												<input type="text"
													style="font-weight: normal; font-size: 14px; background-image: none; color: rgb(54, 35, 219);"
													name="templateFooterbgColor" class="color"
													autocomplete="off"
													value="${listOfEgsdTemplateObjects.templateFooterBackgroundColor}">
												<label
													style="font-weight: normal; font-size: 14px; margin-left: -7px;"
													class="active">Footer Background Color</label>
											</div>
											<div class="input-field col s2">
												<input type="text"
													style="font-weight: normal; font-size: 14px; background-image: none; color: rgb(54, 35, 219);"
													name="templateFooterColor" class="color" autocomplete="off"
													value="${listOfEgsdTemplateObjects.templateFooterTextColor}">
												<label
													style="font-weight: normal; font-size: 14px; margin-left: -7px;"
													class="active">Footer Text Color</label>
											</div>
											<div class="input-field col s2">
												<select name="templateFooterFont" class="browser-default">
													<c:if
														test="${listOfEgsdTemplateObjects.templateFooterFont ne null}">
														<option
															style="font-size:${listOfEgsdTemplateObjects.templateFooterFont}"
															value="${listOfEgsdTemplateObjects.templateFooterFont}">${listOfEgsdTemplateObjects.templateFooterFont}</option>
													</c:if>
													...
													style="font-weight: normal; font-size: 14px; margin-left: -7px;"
													class="active">Footer Font Size</label>
											</div>
											<div class="input-field col s3">
												<select name="templateFooterCaptionFamily"
													class="browser-default">
													<c:if
														test="${listOfEgsdTemplateObjects.templateFooterFontFamily ne null}">
														<option
															style="font-family:${listOfEgsdTemplateObjects.templateFooterFontFamily}"
															value="${listOfEgsdTemplateObjects.templateFooterFontFamily}">${listOfEgsdTemplateObjects.templateFooterFontFamily}</option>
													</c:if>
													...
													style="font-weight: normal; font-size: 14px; margin-left: -7px;"
													class="active">Footer Font Family</label>
											</div>
										</div>

										<div class="input-field">
											<c:if test="${listOfEgsdTemplateObjects.footerDetails}">
												<input type="checkbox" id="templateFooterLock"
													name="templateFooterLock" value="templateFooterLock"
											...
											<label for="templateFooterLock"
												style="font-size: 14px; padding-left: 35px !important;">Lock
												the Standard</label>
										</div>

									</div>

	<!-- 	Apps modal code starts-->
		
									<!-- system global status and list modal -->
									<div id="template77" class="col s10" style="margin-top: 40px;">
									<div class="row">
											<div class="row">
												...
												<label style="font-weight: normal; font-size: 14px;" class="active">eGSD System</label>
													<select class="browser-default" required id="egsdApp" name="egsdApp">
													 <option value="${listOfEgsdTemplateObjects.appId}" selected>"${listOfEgsdTemplateObjects.appName }"</option>
												...
												<div class="input-field col s6">
												<c:choose>
														<c:when test="${listOfEgsdTemplateObjects.globalStatus==true}">
                                                           <input type="checkbox" id="globalcheck" name="globalstatus" style="display:none" checked />
														</c:when>
														<c:otherwise>
                                                            <input type="checkbox" id="globalcheck" name="globalstatus" style="display:none"  />
														</c:otherwise>
													</c:choose>
													<label for="globalcheck" style="font-size: 14px; padding-left: 35px;">Global Participant</label>
												</div>
												</div>
												</div>
									...
									<div class="row">
										<div class="input-field col s6">
							 <c:if test="${listOfEgsdTemplateObjects.appLock}">
								 <input type="checkbox" id="appLock" value="appLock" name="appLock" style="display:none;" checked/>
							</c:if>
							<c:if test="${!listOfEgsdTemplateObjects.appLock}">
								<input type="checkbox" id="appLock" value="appLock" name="appLock" style="display:none;"/>
							</c:if> 
						<!-- 	<input type="checkbox" id="appLock" value="appLock" name="appLock" style="display:none;"/> -->
							<label for="appLock" style="font-size:14px;padding-left:35px !important;">Lock the Standard</label>
						</div>
						<div class="input-field col s6">
							 <c:if test="${listOfEgsdTemplateObjects.globalLock}">
								 <input type="checkbox" id="globalLock" value="globalLock" name="globalLock" style="display:none;" checked/>
							</c:if>
							<c:if test="${!listOfEgsdTemplateObjects.globalLock}">
								<input type="checkbox" id="globalLock" value="globalLock" name="globalLock" style="display:none;"/>
							</c:if> 
							<!-- <input type="checkbox" id="globalLock" value="globalLock" name="globalLock" style="display:none;"/> -->
							
							<label for="globalLock" style="font-size:14px;padding-left:35px !important;">Lock the Standard</label>
						</div>
...
jQuery('#updatePhone').keyup(function () { 
	 ...
	 $.ajax({
			...
			success:function(appData){
				...
				$("#egsdApp").append(editOptions+data+staticfiled);

...
<script src="../assets/dist/jstree.min.js"></script>
<script src="../assets/dist/jstree.dnd.js"></script>
...
<!-- <script type="text/javascript" src="../styles/vendors/bower_components/bootstrap/dist/js/bootstrap.min.js"></script>
...
<body class="loaded" onload="bodyLoad()"
	...
	<div class="navbar-fixed cyan">
		<ul id="dropdown1" class="dropdown-content">
			...
			<li><a  id="acAdmin" style="font-size: 1rem; padding: 0.5rem 0.5rem;">Add CS Admin</a></li> 
   			<li style="min-height:31px"><a id="alAdmin"	style="font-size: 1.5rem; padding:9px 0 9px 17px;">Add Location Admin</a></li>
			...
			<li style="min-height:31px"><a href="#modal2" class="modal-trigger skipTemplate"
				...
				<!-- <li style="min-height:31px"><a href="#modal29" class="modal-trigger skipTemplate"
				style="font-size: 1.5rem; padding:9px 0 9px 17px;">View Templates</a></li> -->
			
			<%-- <li><a href="defaultTemplate?user=${user}&userName=${userName}"
				style="font-size: 1rem; padding: 0.5rem 0.5rem;">Edit
					Default Template</a></li> --%>
			<li><a id="ctemplate" style="font-size: 1.5rem; padding:9px 0 9px 17px;">Create New Template</a></li>
			
			<!-- <li><a href="#chainHotel" class="modal-trigger"
				style="font-size: 1rem; padding: 0.5rem 0.5rem;">Add Chain Hotel</a></li> -->
			<p class="divider"></p>
	...
	<a href="#!" class=" modal-action modal-close waves-effect waves-green btn-flat right">Close</a>
	    ...
	    <div class="modal-content" style="padding:26px 30px 0 30px;height:1000px;">   
	...
	<!-- start of shiva popup -->
	<%--   <div id="modal29" class="modal" style="overflow:auto;width:1400px;overflow:auto">
	  <a href="#!" class=" modal-action modal-close waves-effect waves-green btn-flat right">Close</a>
	     <div class="modal-content">
	       <center><h5 id="locationtext">Shiva</h5></center>
	      ...
	      <div class="main">
                     <div class="table" >
                         <table  style="margin-left:69px;">
                              <thead>
                                     <tr>
                                        <th data-field="show">Show<hr></th>
                                        <th data-field="menu">Menu Description<hr></th>
                                        <th data-field="swque">Menu Sequence<hr></th>
										<th data-field="icon">Icon<hr></th>
                                        <th data-field="show">Show<hr></th>
                                        <th data-field="sequence">Icon Sequence<hr></th>
										<th data-field="item">ItemAction<hr></th>
                                      </tr>
                               </thead>
                               <tbody>
                                    <tr>
                                        <td>
                                        <input type="checkbox" id="test100"/>
                                        </td>
                                        <td>Home</td>
                                        <td></td>
                                        <td><i class="large material-icons">home</i></td>
                                        <td><input type="checkbox" id="test001" /></td>
                                        <td></td>
                                        <td><div id="dvPassport123" style="display: none">
                                                <input type="text" id="quantity0" placeholder="Enter NUmbers Only" style="width:170px;font-size:14px;" />
                                            </div></td>
                                    </tr>
                                    <tr>
										<td>
                                           <input type="checkbox" id="test102" />
									    </td>	
										<td>House Phone</td>
                                        <td></td>
                                        <td><i class="large material-icons">call</i></td>
                                        <td><input type="checkbox" id="test103" /></td>
                                        <td></td>
										<td><div id="dvPassport1" style="display: none">
                                                <input type="text" id="quantity1" placeholder="Enter NUmbers Only" style="width:170px;font-size:14px;" />
                                            </div></td>
                                   </tr>
                                    <tr>
                                        <td>
                                           <input type="checkbox" id="test104"  />
									    </td>	
										<td>Service/Front Desk
										</td>
                                        <td></td>
                                        <td><i class="large material-icons">notifications</i></td>
                                        <td><input type="checkbox" id="test135"  /></td>
                                        <td></td>
										<td><div id="dvPassport50" style="display: none">
                                                <input type="text" id="quantity2" placeholder="Enter NUmbers Only" style="width:170px;font-size:14px;" />
                                            </div></td>
                                    </tr>
                                    <tr>
										<td>
                                           <input type="checkbox" id="test106" />
									    </td>	
										<td>Bellman/Baggage</td>
                                        <td></td>
                                        <td><i class="large material-icons">work</i></td>
                                        <td><input type="checkbox" id="test107" /></td>
                                        <td></td>
										<td><div id="dvPassport7" style="display: none">
                                                <input type="text" id="quantity3" placeholder="Enter NUmbers Only" style="width:170px;font-size:14px;" />
                                            </div></td>
                                   </tr>
								   <tr>
                                        <td>
                                          <input type="checkbox" id="test108" />
									    </td>
										<td>Maid Service</td>
                                        <td></td>
                                        <td><i class="large material-icons">work</i></td>
                                        <td><input type="checkbox" id="test109" /></td> 
                                        <td></td>
										<td><div id="dvPassport9" style="display: none">
                                                <input type="text" id="quantity4" placeholder="Enter NUmbers Only" style="width:170px;font-size:14px;" />
                                            </div></td>
                                   </tr>
								   <tr>
                                        <td>
                                          <input type="checkbox" id="test110" />
									    </td>
										<td>Emergency</td>
                                        <td></td>
                                        <td><i class="large material-icons">home</i></td>
                                        <td><input type="checkbox" id="test111"  /></td>
                                        <td></td>
										<td><div id="dvPassport11" style="display: none">
                                                <input type="text" id="quantity5" placeholder="Enter NUmbers Only" style="width:170px;font-size:14px;" />
                                            </div></td>
                                   </tr>
								   <tr>
                                        <td>
                                           <input type="checkbox" id="test112" />
									    </td>
										<td>Food and Beverage</td>
                                        <td></td>
                                        <td><i class="large material-icons">home</i></td>
                                        <td><input type="checkbox" id="test113" /></td>
                                        <td></td>
										<td><div id="dvPassport13" style="display: none">
                                                <input type="text" id="quantity6" placeholder="Enter NUmbers Only" style="width:170px;font-size:14px;" />
                                            </div></td>
                                   </tr>
								   <tr>
                                        <td>
                                         <input type="checkbox" id="test114" />                                                   
									    </td>
										<td>Taxi</td>
                                        <td></td>
                                        <td><i class="large material-icons">home</i></td>
                                        <td><input type="checkbox" id="test115" /></td>
                                        <td></td>
										<td><div id="dvPassport15" style="display: none">
                                                <input type="text" id="quantity7" placeholder="Enter NUmbers Only" style="width:170px;font-size:14px;" />
                                            </div></td>
                                   </tr>
								   <tr>
                                        <td>
                                        ...
                                        <td></td>
                                        <td><i class="large material-icons">location_on</i></td>
                                        <td><input type="checkbox" id="test117" /></td>
                                        <td></td>
										<td><div id="dvPassport17" style="display: none">
                                                <input type="text" id="quantity8" placeholder="Enter NUmbers Only" style="width:170px;font-size:14px;" />
                                            </div></td>
                                   </tr>
								   <tr>
                                       <td>
                                                     <input type="checkbox" id="test118" />
									    </td>                                       
									   <td>Hotel Directory</td>
                                        <td></td>
                                        <td> <i class="large material-icons">home</i></td>
                                        <td><input type="checkbox" id="test119"  /></td>
                                        <td></td>
										<td><div id="dvPassport" style="display: none">
                                                <input type="text" id="quantity" placeholder="Enter NUmbers Only" style="width:170px;font-size:14px;" />
                                            </div>
                                        </td>
...
$(document).ready(function () {
	    ...
	    <table class="table bordered striped" id="groupSearchResults">
	    	<tbody id="groupBody">
		    	<%-- <tr>
			      ...
			      <c:forEach var="listOfEgsdGroupObjects" items="${listOfEgsdGroupObjects}">
			      <tr>
			       <td style="padding: 6px 0px 0px 30px;"> <a style="color:#337ab7" href="viewGroups?user=${user}&userName=${userName}&tempId=${listOfEgsdGroupObjects.objectId}">
			       ${listOfEgsdGroupObjects.name}
			       </a>
			       </td>
			       <td style="padding:10px 0"> <a  href="viewGroups?user=${user}&userName=${userName}&tempId=${listOfEgsdGroupObjects.objectId}" style="color:#337ab7">
			       ${listOfEgsdGroupObjects.objectId}
			       </a>
			       </td>
 ...
 <!--  create Add Super admin popup -->
  ...
  <c:forEach var="locObj" items="${locObj}">
    ...
    <form:form action="registerSuperAdmin?user=${user}&userName=${userName}&locId=${locObj.objectId}" method="post" id="myform2"> 
    <a href="#"  class=" waves-effect waves-green btn-flat modal-action modal-close right  waves-effect waves-light btn" id="reset"   style="color:#26a69a;">Close</a>
    <!-- <button type="reset" class="btn clearData waves-effect waves-green btn-flat modal-action modal-close right  waves-effect waves-light btn" style="margin-top:10px;width:100px;color:white;"><a href="#"></a>CLEAR</button>  -->
      ...
      <div class="input-field col s12">
       ...
       <input  type="text" name="firstname" class="customFont" id="superFirstname"  style="padding: 0 10px 0 10px;width:587px;">
       <span id="sfnameErr" style="color:red;font-size:12px"></span>
       <label  class="customFont center-align active" style="margin-left:-8px;">First Name</label>
      </div>
     </div>
        <div class="row margin">
      <div class="input-field col s12">
       <!--             <i class="mdi-social-person-outline prefix"></i> -->
       <input class="customFont" type="text" name="lastname" id="superLastname"  style="padding: 0 10px 0 10px;width:587px;">
       <span id="slnameErr" style="color:red;font-size:12px"></span>
       <label  class="customFont center-align active" style="margin-left:-8px;">Last Name</label>
      </div>
     </div>
      <div class="row margin">
      <div class="input-field col s12">
       <!--             <i class="mdi-social-person-outline prefix"></i> -->
       <input class="customFont" type="text" name="username" required id="superUsername"  style="padding: 0 10px 0 10px;width:587px;">
       <span id="sunameErr" style="color:red;font-size:12px" ></span>
       <label  class="customFont center-align active" style="margin-left:-8px;">User Name</label>
      </div>
     </div>
     <div class="row margin">
      <div class="input-field col s12">
       <!--             <i class="mdi-social-person-outline prefix"></i> -->
       <input class="customFont" type="email" name="email" id="superEmail" required style="padding: 0 10px 0 10px;width:587px;">
       <span id="semailErr" style="color:red;font-size:12px"></span>
       <label  class="customFont center-align active" style="margin-left:-8px;">Email</label>
      </div>
     </div>
     ...
     <input type="hidden" value="${locObj.objectId}" id="locId">
           ...
           <div class="row">
             <div class="input-field col s12">
               <button type="submit" id="createSuperAdmin" class="btn waves-effect waves-light col s12" style="color:white">Create Super Admin</button>
   ...
   <%-- <form:form action="registerCSAdmin?user=${user}&userName=${userName}&locId=${locObj.objectId}" method="post" > --%>
    <a href="#!" class=" modal-action modal-close right waves-effect waves-green btn-flat" >Close</a>
      ...
      <div class="input-field col s12">
       ...
       <label  class="customFont center-align active">First Name</label>
      </div>
     </div>
        <div class="row margin">
      <div class="input-field col s12">
       <!--             <i class="mdi-social-person-outline prefix"></i> -->
       <input class="customFont" type="text" name="lastname" id="csLastname" style="padding: 0 10px 0 10px">
...
<!--   start location admin popup -->
  ...
  <%--  <form:form action="registerLocationAdmin?user=${user}&userName=${userName}&locId=${locObj.objectId}" method="post" > --%>
    <a href="#!" class=" modal-action modal-close right waves-effect waves-green btn-flat">Close</a>
       ...
       <center><h5 id="locationtext"> Edit Location Admin User </h5></center>
       <input type="hidden" id="laEmail"/>
          <center><span class="userExisted" style="color:red;font-size:13px;"></span></center>
          <div class="row margin">
      <div class="input-field col s12">
       <!--             <i class="mdi-social-person-outline prefix"></i> -->
       <input  type="text" class="customFont" name="firstname" id="locationFirstname" style="padding: 0 10px 0 10px;width:597px;">
       <span id="lfnameErr" style="color:red;font-size:12px;    padding:0px;"></span>
      ...
      <div class="input-field col s12">
       <!--             <i class="mdi-social-person-outline prefix"></i> -->
       <input  type="text" name="lastname" class="customFont" id="locationLastname" style="padding: 0 10px 0 10px;width:597px;">
      ...
      <div class="input-field col s12">
       <!--             <i class="mdi-social-person-outline prefix"></i> -->
       <input  type="text" name="username" class="customFont" id="locationUsername" required style="padding: 0 10px 0 10px;width:597;">
      ...
      <div class="input-field col s12">
       <!--             <i class="mdi-social-person-outline prefix"></i> -->
       <input  type="email" name="email" class="customFont" id="locationEmail" required style="padding: 0 10px 0 10px;width:587px;">
 ...
 --%>
    ...
    margin-top: -21px; ">
      <ul class="tabs tabs-left"style="margin-top: 45px;">
        ...
        <!-- <li class="tab col s12"><a href="#test7"style="color:white !important">Addmenu</a></li>
    ...
    <div id="title${showDiscriptionObjId.objectId}" class="col s10"style="margin-top: 40px;">
		...
		<!-- <a class="waves-effect waves-light btn" style="float: right;">Next</a> -->
    </div>
...
<button type="submit" class="btn " style="margin-top:10px;width:100px;color:white;">CLEAR</button>
	...
	<!-- <div class="manageTextBoxesGroup">
												...
												<div class="manageTextBoxDiv2"><div class="row"><div class="input-field col s3"><select name="manageType2" style="display:-webkit-inline-box;" class="type2"><option value="" disabled="" selected="">Phone/Email/Website</option><option value="phone">Phone</option><option value="email">Email</option><option value="website">Website</option></select></div><div class="input-field col s2"><input class="details2" type="text" name="manageDetails2"><label for="first_name"></label></div><input type="button" value="Delete" class="manageRemoveButton btn input-field col s1"></div></div></div>										 -->
	...
	<%-- 	<div class="editPopup"
			...
			<div id="edit" class="modal" style="width:75%">
				...
				<div class="modal-content">
					...
					<center><h5 > Edit Directory Item </h5></center>
					<c:forEach var="showDiscriptionObjId"
						items="${showDiscriptionObjId }">
									...
									<c:if
										...
										<c:forEach var="locObjForEdit" items="${locObjForEdit}">
											...
											<div class="row">
												...
												<div class="input-field col s2">
													<select class="browser-default" name="timingsFont" id="${showDiscriptionObjId.objectId}:timingsFont">
												...
												<div class="input-field col s3">
													<select class="browser-default" name="timingsFamily" id="${showDiscriptionObjId.objectId}:family">
											...
											<div class="row">
												...
												<div class="input-field col s2">
													<select class="browser-default" name="descriptionFont" id="${showDiscriptionObjId.objectId}:descriptionFont">
												...
												<div class="input-field col s3">
													<select class="browser-default" name="descriptionFamily" id="${showDiscriptionObjId.objectId}:descriptionFamily">
														<option value="${styleObjectsForEdit.descriptionFamily}" style="font-family:${styleObjectsForEdit.descriptionFamily}" selected>${styleObjectsForEdit.descriptionFamily}</option>
														<option value="Courier New" style="font-family:Courier New">Courier New</option>
														<option value="Lucida Console" style="font-family:Lucida Console">Lucida Console</option>
														<option value="Verdana" style="font-family:Verdana">Verdana</option>
														<option value="Trebuchet MS" style="font-family:Trebuchet MS">Trebuchet MS</option>
											...
											<div class="row">	
															...
															<div class="input-field col s3">
																<select class="browser-default font1" name="editpriceFont">
																	...
																	<option selected value="${styleObjectsForEdit.priceFont}" style="font-size: ${styleObjectsForEdit.priceFont}">${styleObjectsForEdit.priceFont}</option>
																	<option value="initial" style="font-size: initial" >initial</option>
																	<option value="xx-small" style="font-size: xx-small">xx-small</option>
																	<option value="x-small" style="font-size: x-small">x-small</option>
																	<option value="small" style="font-size: small">small</option>
															...
															<div class="input-field col s3">
																<select class="browser-default family1" name="editpriceFamily">
																	<option selected value="${styleObjectsForEdit.priceFamily}" style="font-family:${styleObjectsForEdit.priceFamily}">${styleObjectsForEdit.priceFamily}</option>
																	<option value="Courier New" style="font-family:Courier New">Courier New</option>
														<option value="Lucida Console" style="font-family:Lucida Console">Lucida Console</option>
														<option value="Verdana" style="font-family:Verdana">Verdana</option>
														<option value="Trebuchet MS" style="font-family:Trebuchet MS">Trebuchet MS</option>
		...
		<div class="editLocation"
			...
			<div id="editLocation" class="modal" style="overflow:auto">
				<a href="#"
				...
				<div class="modal-content">
					...
					<c:forEach var="locObjForEditLocation"
						...
						<div class=${locObjForEditLocation.objectId }
							...
							<form:form action="editLocation" commandName="addLocation"	enctype="multipart/form-data">
								...
								<div class="">
									<div class="input-field col s6">
										<input type="text" name="name" required
											...
											style="font-size: 14px; font-weight: normal; padding: 0 10px 0 10px;">
										<label class="active" for="first_name2"
											style="font-size: 14px; font-weight: normal;margin-left:-11px;">Description</label>
									</div>
								</div>
								<div class="">
									<div class="input-field col s6">
		...
		<div class="deleteLocation"
			style="display: none; opacity: 1; top: 10%; max-height: 50%; padding: 0 25px 0 25px;">
			<div id="deleteLocation" class="modal" style="height:208px;">
				<a href="#"
					class="waves-effect waves-green btn-flat modal-action modal-close right">Close</a>
				<div class="modal-content">
...
">
      <ul class="tabs tabs-left"style="margin-top: 45px;">
        ...
        <li class="tab col s12"><a href="#test5"style="color:white !important">Images</a></li>
   ...
   <div class="input-field col s12"
						style="margin: 10px 0 0 0px;padding:0 0 0 0">
			<!-- <div class="input-field col s3 m3 l3">
									              <input type="checkbox" name="editmenu:" id="editmenu" onclick="edithandleClick;"/>
									              <label for="editmenu:">Add Menu</label>-->
	<!-- 								          
	 <ul class="collapsible" data-collapsible="accordion">
    <li>
      <div class="input-field col s3 m3 l3"> <input type="checkbox" name="editmenu:" id="check:HBFJRBdxRo" onclick="edithandleClick;"/>
	  <label for="editmenu:">Add Menu</label></div>
      <div class="collapsible-body"><p>Lorem ipsum dolor sit amet.</p></div>
			 ...
			 -->						          
									        ...
									        <!-- <div class="input-field col s3 m3 l3">
									              <input type="checkbox" id="check:HBFJRBdxRo" onclick="handleClick(this.id);">&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;<label for="check:HBFJRBdxRo" style="margin-left:50px;size: 100px;">Add Menu</label>
									          </div>  --> 
...
<label for="myCheckbox">shiva</label> -->
...
<!-- <button type="submit" class="btn " style="margin-top:41px;margin-left: -205px;width:100px;color:white;">SAVE</button> -->
 ...
 <br/>
<!-- <a href="javascript: directorySubmitForm()" class="btn" style="margin-top:10px;margin-left:33px;width:100px;color:white;" >Save</a>
<button type="reset" class="btn clearData" style="margin-top:10px;width:100px;color:white;">CLEAR</button>     -->
    </div>
...
<!--  <div id="test7" class="col s10">
  ...
  <div class="col s12" id="contactHBFJRBdxRo" style="padding: 0px; display: block;">
	...
	<br/>
<a href="javascript: directorySubmitForm()" class="btn" style="margin-top:10px;margin-left:33px;width:100px;color:white;" >Save</a>
<a href="#" class="btn clearData" style="margin-top:10px;width:100px;color:white;">CLEAR</a>
    ...
    <!-- </div>
						...
						<div class="${locObjForAddDirectoryItems.objectId}"
							...
							<div class="row">
								<form:form class="col s12" action="addDirectory" method="post"
									...
									<input type="input" value="${userName}" name="userName">
									<input type="hidden" value="${user}" name="user">
									<!--Displaying Title  -->
									<!--Displaying Title  -->
											<div class="row">
												...
												<div class='TextBoxesGroup'>
													<div class="TextBoxDiv1">
														<div class="row">
															...
															<div class="input-field col s4" style="margin-left:16px;">
															...
															<div class="input-field col s2">
																...
																<input type='button' value='Delete' style="width:70px;color:white;" class='removeButton btn input-field col s1'>
												...
												<div class='manageTextBoxesGroup' >
													<div class="manageTextBoxDiv1">
														<div class="row">
															...
															<input type='button' value='Delete' style="color:white;margin-left:10px;margin-top:15px;" class='manageRemoveButton btn input-field col s1'>
		...
		<div class="delPopup"
			...
			<div id="delete" class="modal" style="height:200px;">
				<a href="#"
					class="waves-effect waves-green btn-flat modal-action modal-close right">Close</a>
				<div class="modal-content">
 ...
 --%>
		...
		<a class="waves-effect waves-light btn modal-trigger" style="display:none" id="narshimha" href="#modal6">Modal</a>
			<div id="modal6" class="modal" style="height: 200px;margin-top:20px;">
			    <div class="modal-content">
			     	 <p style="font-size: 14px;"><span id="userType" ></span> has been created successfully. Notification email has been sent to the email id entered with user credentials.</p>
				 <a href="#!" class="waves-effect waves-light btn modal-trigger right" style="margin-left: 542px;color:white;">Ok</a>
			    </div>
...
<!-- 		<script type="text/javascript" src="../styles/js/functions.js"></script>
 -->		<!-- <script type="text/javascript" src="../styles/js/demo.js"></script> -->
		<!-- <script src="../styles/vendors/bower_components/bootstrap/dist/js/bootstrap.min.js"></script> -->
    ...
    $("body").on("click", ".removeButton", function () {
		...
		<script type="text/javascript">
			...
			function add_DirectoryItems_click(clicked_id) {
				...
				$("#formAction").attr("action", "addDirectoryItems");

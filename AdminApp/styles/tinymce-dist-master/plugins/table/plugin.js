...
define("tinymce/tableplugin/Dialogs", [
	...
	return function(editor) {
		...
		function mergeStyles(dom, elm, styles) {
			...
			console.log("1");
			console.log(dom.serializeStyle(dom.parseStyle(dom.serializeStyle(css))));
						...
						items: [
							...
							},
							{
								...
								values: [
									...
									{text: 'RowGroup', value: 'rowgroup'},
									{text: 'ColumnGroup', value: 'colgroup'}
								]
							},
							{
								label: 'H Align',

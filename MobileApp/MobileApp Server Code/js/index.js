...
var app = {
    ...
    onDeviceReady: function() {
        ...
        cordova.plugins.diagnostic.requestLocationAuthorization(function(status) {
            console.log("Authorization request for location access was " + (status == cordova.plugins.diagnostic.permissionStatus.GRANTED ? "granted" : "denied"));
        }, function(error) {
            console.error(error);
        });
...
function InitSession(isResume) {
    ...
    Branch.initSession().then(function(res) {
        ...
        var resultparse = undefined;
        resultparse = JSON.stringify(res);
        if (res['+clicked_branch_link']) {
        ...
        } else if ((resultparse == "") || (resultparse == undefined) || (result == undefined) || (result == "")) {
            ...
            if ((Lid != undefined) || (Lid != null)) {
                ...
                // } else {
                //     alert("model id" + JSON.stringify($('#myModal')));
                //     $('#myModal').modal('show');

...
function myFunction() {
    ...
    if ((hRes != null) && (hRes.length > 0) && (hRes[0].objectId == id)) {
        ...
        function LocationFun() {
            ...
            locQuery.find().then(function(result) {
                                ...
                                else if (result[0].get("AppId")== "None" || result[0].get("AppId")!== "WHG"){
                                 localStorage.clear();
                                 window.open("notFound.html", "_self")
                                 } else {
    ...
    function showHotel() {
        ...
        if (hRes[0] != null) {
            ...
            var dataurl="https://egsd-whg.app.link/?param=directories.html&id="+parentid;
            var whatsappurl="https://egsd-whg.app.link/?param=directories.html%26id="+parentid;
            /*  var maildataurl="https://bnc.lt/a/key_live_hhoW7g0luMxwlGYKg4TelepbrzdSrV36?%26param=directories.html?id="+parentid; */
            var maildataurl="https://egsd-whg.app.link?param=directories.html%26id="+parentid;
            var smsurl="https://bnc.lt/a/key_live_gcvqXCr6xFPow2LCtXn3LjpkxsnvdUC9?¶m=directories.html?id="+parentid;
